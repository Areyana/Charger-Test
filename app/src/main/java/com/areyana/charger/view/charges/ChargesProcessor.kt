...
class ChargesProcessor(private val chargesArg: ChargesArg): MviProcessor<ChargesState, ChargesIntent, ChargesSingleEvent>() {
...
sealed interface ChargesState : State {
    ...
    data class Idle(val cities: Map<String, List<Charge>>): ChargesState
}